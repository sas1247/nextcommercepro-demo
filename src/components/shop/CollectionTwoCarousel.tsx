...
export default function CollectionTwoCarousel({ items }: { items: Item[] }) {
  const pageSize = 5;
  const cart = useCart();
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-6 md:py-10">
      {/* Section header (mobile: smaller, button in one line) */}
      <div className="flex items-end justify-between gap-3 mb-4 md:mb-5">
        <div className="min-w-0">
          <h2 className="text-lg md:text-2xl font-semibold text-black leading-tight">
            Featured Collection Two
          </h2>
          <p className="text-xs md:text-sm text-neutral-600 mt-1">Premium look and feel</p>
        </div>
